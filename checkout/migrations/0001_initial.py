    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 1.000.000'}}, help_text='Maximum 1.000.000', max_digits=4, verbose_name='delivery price')),
